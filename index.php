		...
		<div id="promotions">
			...
			<div class="promo">
				...
				<div class="promo-image">
					<img src="images/<?php print $promo['header_image']; ?>">
				</div>
				...
				<div class="promo-small">
					<div class="promo-small-image">
						<img src="images/<?php print $promo['lower_image']; ?>">
					</div>
					<div class="promo-small-text-title">
						<?php print $promo['lower_header']; ?>
					</div>
					<div class="promo-small-text">
						<?php print $promo['lower_body_text']; ?>
					</div>
				</div>
				<div class="promo-small">
					<div class="promo-small-image">
						<img src="images/<?php print $promo['lower_image2']; ?>">
					</div>
					<div class="promo-small-text-title">
						<?php print $promo['lower_header2']; ?>
					</div>
					<div class="promo-small-text">
						<?php print $promo['lower_body2']; ?>
					</div>
				</div>
			</div>
			<?php endforeach; ?>		
